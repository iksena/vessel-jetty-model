...
export const validateVesselForm = ({
  ...
  ...(minSafeload < jettyData.safeload.min) && { minSafeload: `L to L Safeload must be greater than ${jettyData.safeload.min}` },
  ...(maxSafeload > jettyData.safeload.max) && { maxSafeload: `L to L Safeload must be less than ${jettyData.safeload.max}` },
